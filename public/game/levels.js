  ...
  const levels = [
    ...
    },
    {
      ...
      sections: [
        ...
        { id: 'caldera-kaboom', name: 'Caldera KABOOM', start: 19000, end: 27000, focus: 'Rainbow eruption jackpot and a falling-rock escape completed on foot' },
        { id: 'taco-trekker-escape', name: 'Taco Trekker Escape', start: 27000, end: 35000, focus: 'Final geyser launch, Olivia Jeep rescue, boarding, and scripted volcano evacuation' },
      ],
      signatureSystems: [
        'Volcano visible and evolving throughout the entire level',
        'Premium Olivia with short brown hair and pink-and-blue bangs',
        'Compact Taco Trekker drop plus a one-shot Olivia Jeep rescue finale',
        'Premium telegraphed geyser launchers with a four-vent Geyser Garden orchestra',
        ...
        'Falling-rock on-foot escape and scripted Taco Trekker evacuation',
      ],
      music: {
        ...
        arrangements: [
          ...
          { id: 'luau', name: 'Taco Trekker Getaway', start: 27000, end: 35000, bpm: 124, asset: 'assets/level2_2_music/music_caldera_luau.ogg' },
        ],
      },
      olivia: {
        ...
        checkpoints: [
          ...
          { x: 33050, name: 'Taco Trekker Safe Point' },
        ],
      },
    },
    {
