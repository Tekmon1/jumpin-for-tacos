...
test("rebuilds Speaker Stack Stampede as a true vertical station with a scoped hysteresis camera", async () => {
  ...
  assert.match(runtime, /function drawSpeakerStackFoundationBay/);
  assert.match(runtime, /function drawSpeakerStackStructuralFoundation/);
  ...
  assert.match(runtime, /const SPEAKER_STACK_STRUCTURAL_FOUNDATION = Object\.freeze/);
  assert.match(runtime, /continuousStructuralFoundation: true/);
  assert.match(runtime, /foundationBayCount: SPEAKER_STACK_STRUCTURAL_FOUNDATION\.bays\.length/);
  assert.match(runtime, /foundationLoadColumnCount: SPEAKER_STACK_STRUCTURAL_FOUNDATION\.loadColumns\.length/);
  assert.match(runtime, /lightweightGroundFeetRemoved: true/);
  assert.match(runtime, /foundationNonWalkableBackdrop: true/);
